                        ...
                        <div className="flex flex-col md:flex-row items-center gap-4">
                            ...
                            {movie.trailer && (
                                <button
                                    ...
                                    className="w-full md:w-auto px-8 py-3.5 bg-bg-tertiary hover:bg-bg-tertiary/80 text-white font-bold text-base rounded-lg transition-all duration-200 flex items-center justify-center gap-2 group border border-white/10"
                                >
