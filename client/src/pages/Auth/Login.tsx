  ...
  return (
    <div className="mx-auto w-full max-w-sm rounded-xl border border-neutral-200 bg-white/80 p-6 shadow-sm backdrop-blur dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <form onSubmit={onSubmit} className="grid gap-4">
        ...
        <button
          type="submit"
          className="inline-flex h-10 items-center justify-center rounded-md bg-blue-400 px-4 text-sm font-medium text-white shadow-sm transition-colors hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 disabled:opacity-50"
        >
          Login
        </button>
      </form>
